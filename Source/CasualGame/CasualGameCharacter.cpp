...
ACasualGameCharacter::ACasualGameCharacter()
{
...
void ACasualGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACasualGameCharacter::Move);
...
void ACasualGameCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACasualGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
